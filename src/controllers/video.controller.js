...
const videoHealthCheck = aysncHandler( async (req,res) => {
...
const createVideo = aysncHandler( async (req,res) => {
...
const updateVideoDetails = aysncHandler( async (req,res) => {
...
const updateVideoThumbnail = aysncHandler( async (req,res) => {
